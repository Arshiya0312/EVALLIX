      ...
      >
        <GlassCard className="p-10 border-white/40 dark:border-white/10" hoverLift={false}>
          <div className="flex flex-col items-center gap-4 mb-10">
            <div className="w-20 h-20 rounded-2xl flex items-center justify-center overflow-hidden transform -rotate-6 shadow-2xl">
               <img 
                 src={logo} 
                 alt="Evalix Logo" 
            ...
            <div className="text-center">
              <h1 className="text-2xl font-black tracking-tighter mb-1 uppercase">Evalix Hub</h1>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">EVALUATION READY</p>
            </div>
          </div>
